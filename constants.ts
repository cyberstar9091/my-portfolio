...
export const METADATA = {
  title: "Portfolio | Maksym M.",
  description:
    "I bridge the gap between design and development. I take responsibility to craft an aesthetic user experience using modern frontend architecture.",
  siteUrl: "https://morarmaksym.net/",
};
...
export const EMAIL = "maksym.morar.xda@gmail.com";

export const SOCIAL_LINKS = {
  linkedin: "https://www.linkedin.com/in/alphamaksym/",
  github: "https://github.com/maksym013",
};
...
export const PROJECTS: IProject[] = [
  ...
  //   url: "https://farewell18.maksymmorar.net/",
  //   tech: ["javascript", "html", "css"],
  // },
  // {
  ...
  //   url: "https://bdc2018.maksymmorar.net/",
  //   tech: ["javascript", "html", "css"],
  // },
  // {
  ...
  //   url: "https://scrolls-17.maksymmorar.net/",
  ...
  //   url: "https://cardize.maksymmorar.net/",
  //   tech: ["javascript", "html", "css"],
  // },
];
...
export const TIMELINE: Array<TimelineNodeV2> = [
  ...
  },
  {
    ...
    size: ItemSize.SMALL,
    subtitle:
      "Developed lots of websites by FULL STACK",
    image: "/timeline/full.jpg",
    slideImage: "/timeline/fullstack.jpg",
    shouldDrawLine: true,
    alignment: Branch.LEFT,
  },
  {
  ...
  },
  {
    ...
    size: ItemSize.SMALL,
    subtitle:
      "Backend Engineering @ Core team, solving problems around Livingroom device performance",
    image: "/timeline/node.svg",
    slideImage: "/timeline/backend.gif",
    shouldDrawLine: true,
    alignment: Branch.LEFT,
  },
  {
  ...
  },
  {
    ...
    size: ItemSize.SMALL,
    subtitle:
      "Contributed to User-friendly UI for powering experiences.😎",
  ...
  },
  {
    ...
    subtitle:
      "Contributed to User-friendly UI for powering experiences.😎",
    image: "/timeline/svg.svg",
    slideImage: "/timeline/UI.jpg",
    shouldDrawLine: true,
    alignment: Branch.LEFT,
  },
  // {
